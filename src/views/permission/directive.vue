  ...
  <div class="app-container">
    ...
    <div :key="key" class="margin-top-30">
      <div>
        <el-tag
          ...
          effect="plain"
        >
          这里采用了 v-permission="['admin']" 所以只有 admin
          可以看见这句话
        </el-tag>
      </div>
      <div>
        <el-tag
          ...
          effect="plain"
        >
          这里采用了 v-permission="['editor']" 所以只有
          editor 可以看见这句话
        </el-tag>
      </div>
      <div class="margin-top-15">
        <el-tag
          ...
          effect="plain"
        >
          这里采用了 v-permission="['admin', 'editor']" 所以
    ...
    >
      <el-tag type="warning" size="large">
        ...
        以及其它动态渲染 Dom 的场景不适合使用
        v-permission，这种情况下你可以通过 v-if 和
        checkPermission 来实现：
      </el-tag>
